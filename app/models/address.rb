class Address < ApplicationRecord
  ...
  def to_s
    ...
    return self.house_number + " " + self.street_predirection + " " + self.street_name + " " + self.street_type + " " ++ self.street_postdirection + " " + self.unit_type + " " + self.unit_number + ", " + self.city + ", " + self.state + " " + self.zip_5;
    # binding.pry
    # puts self.id;
  end
end
